...
if __name__ == "__main__":
    from cardnews_config import ACCOUNTS

    with open("cardnews_config.py", "r", encoding="utf-8") as f:
    ...
    update_github_secret(gh_pat, "leekyuhwan0-cpu", "cardnews-auto", "CARDNEWS_CONFIG", new_config_b64)
